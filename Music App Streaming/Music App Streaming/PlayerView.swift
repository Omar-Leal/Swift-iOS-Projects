    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                Text(song.name).fontWeight(.light).foregroundColor(.white)
                Spacer()
                ...
                ZStack {
                    ...
                    HStack {
                        ...
                        Button(action: self.playPause, label: {
                            Image(systemName: isPlaying ? "pause.circle.fill" : "play.circle").resizable()
                        }).frame(width: 70, height: 70, alignment: .center).padding(10)
